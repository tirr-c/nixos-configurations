# Generated by Powerlevel10k configuration wizard on 2020-05-13 at 14:25 KST.
...
# solid, no frame, lightest-ornaments, sparse, few icons, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='${IN_NIX_SHELL} ${name}'
